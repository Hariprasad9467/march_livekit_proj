...
class _ApplyLeaveState extends State<ApplyLeave> {
  ...
  Future<void> _fetchApprovers(String employeeId) async {
    try {
      final response = await http.get(
        Uri.parse('https://march-livekit-proj.onrender.com/apply/approvers/$employeeId'),
      );
      if (response.statusCode == 200) {
  ...
  void _submitLeave() async {
    ...
    final url = isEditing
        ? 'https://march-livekit-proj.onrender.com/apply/update/$employeeId/$leaveId'
        : 'https://march-livekit-proj.onrender.com/apply/apply-leave';
