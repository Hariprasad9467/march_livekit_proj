  ...
  Future<void> fetchExitDetails() async {
    try {
      final response = await http.get(
        Uri.parse("https://march-livekit-proj.onrender.com/api/exitDetails"),
      );
  ...
  Future<void> deleteExitRecord(String id) async {
    try {
      final response = await http.delete(
        Uri.parse("https://march-livekit-proj.onrender.com/api/exitDetails/$id"),
      );
      ...
      if (e["exitDocument"] != null && e["exitDocument"].toString().isNotEmpty)
        IconButton(
          ...
          onPressed: () {
            ...
            final url = "https://march-livekit-proj.onrender.com/api/exitDetails/file/$fileName";
